   ...
   <footer className='py-12 border-t '>
     <div  className=' container mx-auto grid grid-cols-1 space-y-2 md:grid-cols-4  px-4 gap-x-8 '>
        ...
        <div>
            ...
            <form className='flex'>
                <input type='email' required className='border-l border-b border-t border-gray-300 h-10 rounded-l-md transition-all focus:outline-none focus:ring-2 focus:ring-gray-500' placeholder='email'/>
                <button className='bg-black text-white text-sm hover:bg-slate-700 px-2 rounded transition-all '>
                    Subscribe
                </button>
            </form>
        </div>
